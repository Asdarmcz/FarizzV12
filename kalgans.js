...
🌷 KALAU MAU RENAME TARO CREDITS GUA : RZ☆ */
...
browser: ['F A R I Z Z-MD','Safari','1.0.0'],
auth: state})
//=================================================//
...
he = `HELLO 👋 SELAMAT DATANG BEBAN DI GROUP ${metadata.subject} @${num.split("@")[0]}\n\n${metadata.desc}`
